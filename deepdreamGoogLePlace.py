###############################################################################
#
# deepdreamGoogLePlace.py
#  - test script for GoogLeNet trained on the MIT Places database
#
###############################################################################
...
model_path = './models/googlenet_places205/' # substitute your path here
...
net = caffe.Classifier('tmp.prototxt', 
                       ...
                       channel_swap = (2,1,0)) 
                        # ref model has channels in BGR order instead of RGB
